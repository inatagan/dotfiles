...
The instructions below are outdate, I've since moved on from using my own setup script to instead simply use GNU Stow.

I have update the directory structures to reflect that, now simply link whatever app config you want using Stow.

###TODO:
I still have to better clean up old and redudant files.
